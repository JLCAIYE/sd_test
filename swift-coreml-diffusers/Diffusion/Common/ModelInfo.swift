...
extension ModelInfo {
    ...
    func modelURL(for variant: AttentionVariant) -> URL {
        ...
        //https://drive.google.com/file/d/1P4NbzwSonvu64f4GMi_PODQ7CoWo9GjP/view?usp=drive_link
        let suffix: String
        switch variant {
        ...
        return URL(string: "https://huggingface.co/CAIYE123/demov15/resolve/main/sdv15.zip")!
    }
